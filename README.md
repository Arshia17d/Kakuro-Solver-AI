...
برای حل این مسئله از دو الگوریتم Backtracking با Forward Checking و Min-Conflicts استفاده شده و زمان اجرای آن‌ها مقایسه می‌شود. ورودی برنامه از فایل input.txt خوانده شده و خروجی جدول حل‌شده را نمایش می‌دهد.
